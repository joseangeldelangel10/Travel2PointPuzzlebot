...
class redCirclesDetector():
    def __init__(self):
        ...
        rospy.init_node("GreenCirclesDetector")       
        #susbcribers
        self.imageSubscriber = rospy.Subscriber("/video_source/raw",Image,self.on_image_callback)        
        self.bridge = cv_bridge.CvBridge()        
        #publishers
        self.pub_red = rospy.Publisher("/processedImage/detectedObjects/greenCircle", Bool, queue_size=10)
        self.pub_red_img = rospy.Publisher("/processedImage/detectedObjects/greenCircleImage", Image, queue_size=10)        
        self.image = None
    ...
    def main(self):
        while not rospy.is_shutdown():
            if (self.image != None):
                ...
                self.processedImage2 = cv.inRange(self.processedImage,(38,50,40),(85,255,255))     
